...
def find_fields_in_content(input_json_file, fields_json_file, output_csv_file):
    ...
    with open(output_csv_file, "w", newline="", encoding="utf-8") as f:
        writer = csv.writer(f)
        writer.writerow(["chunkid", "frame name", "section_number", "element name", "frequency_count"])  # header
...
frame_link_element = os.environ.get("FRAME_LINK_ELEMENT")

find_fields_in_content(input_chunk_file, input_element_list, frame_link_element)
